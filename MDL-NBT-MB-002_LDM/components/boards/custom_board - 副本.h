...
#define SI4432_NIRQ  16
	
// LEDs definitions for PCA10040
#define LEDS_NUMBER    4

#define LED_START      28//17
#define LED_1          28//17
#define LED_2          29//18
#define LED_3          30//19
#define LED_4          31//20
#define LED_STOP       31//20
   
#define LEDS_ACTIVE_STATE 1//0
...
#define SPIM0_SCK_PIN   18//29  // SPI clock GPIO pin number.
#define SPIM0_MOSI_PIN  19//25  // SPI Master Out Slave In GPIO pin number.
#define SPIM0_MISO_PIN  20//28  // SPI Master In Slave Out GPIO pin number.
#define SPIM0_SS_PIN    17//12  // SPI Slave Select GPIO pin number.
